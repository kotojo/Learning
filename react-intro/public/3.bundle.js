	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      axios.get('http://www.omdbapi.com/?i=' + this.props.shows[this.props.params.id].imdbID).then(function (res) {
	    ...
	    key: 'render',
	    value: function render() {
	      var _props$shows$props$pa = this.props.shows[this.props.params.id];
	      var title = _props$shows$props$pa.title;
	      var description = _props$shows$props$pa.description;
	      var year = _props$shows$props$pa.year;
	      var poster = _props$shows$props$pa.poster;
	      var trailer = _props$shows$props$pa.trailer;
